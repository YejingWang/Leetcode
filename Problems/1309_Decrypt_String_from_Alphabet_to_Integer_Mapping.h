...
/*
Tips:
	1.Time complexity of solution 1 is O(N^2) since we keep adding char to res (O(1 + 2 + .. +N) = O(N^2))
	2.We should use std::string::resize() instead of std::string::reserve()
*/